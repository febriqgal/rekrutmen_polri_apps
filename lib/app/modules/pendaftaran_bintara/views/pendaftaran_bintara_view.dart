...
class PendaftaranBintaraView extends GetView<PendaftaranBintaraController> {
  const PendaftaranBintaraView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pendaftaran Bintara'),
        centerTitle: true,
      ),
      body: ListView(
        children: [
