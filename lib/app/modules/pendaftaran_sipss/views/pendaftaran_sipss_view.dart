...
class PendaftaranSipssView extends GetView<PendaftaranSipssController> {
  const PendaftaranSipssView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pendaftaran SIPSS'),
        centerTitle: true,
      ),
      body: ListView(
        children: [
