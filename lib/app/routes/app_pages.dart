...
import 'package:rekrutmentpolri/app/modules/gallery_kegiatan/bindings/gallery_kegiatan_binding.dart';
import 'package:rekrutmentpolri/app/modules/gallery_kegiatan/views/gallery_kegiatan_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.GALLERY_KEGIATAN,
      page: () => const GalleryKegiatanView(),
      binding: GalleryKegiatanBinding(),
    ),
  ];
}
